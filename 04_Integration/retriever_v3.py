...
VECTOR_STORE_PATH = os.path.join(BASE_DIR, "../Day_08_Advanced_Data_Engineering/vector_store_v2.faiss")
VECTOR_METADATA_PATH = os.path.join(BASE_DIR, "../Day_08_Advanced_Data_Engineering/vector_metadata_v2.json")
GRAPH_PATH = os.path.join(BASE_DIR, "../Day_09_LLM_Graph/graph_v2.gpickle")
